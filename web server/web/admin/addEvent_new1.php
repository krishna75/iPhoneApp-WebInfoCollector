...
$title = "Add Event";
$action = "model_addEvent_new1.php";
...
?>
    ...
    <li id="li_9">
        ...
        <p><a href="noJs.html" class="date-pick dp-applied">Pick some event dates</a></p>
        <span>Selected dates:</span> <span id="date-label">none</span>
