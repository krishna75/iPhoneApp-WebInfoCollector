...
<li id="li_9" >
    ...
    <span>
        <input id="element_9_1" name="dd" class="element text" size="2" maxlength="2" value="" type="text"> /
        <label for="element_9_1">DD</label>
    </span>
    <span>
        <input id="element_9_2" name="mm" class="element text" size="2" maxlength="2" value="" type="text"> /
        <label for="element_9_2">MM</label>
    </span>
    <span>
        <input id="element_9_3" name="yyyy" class="element text" size="4" maxlength="4" value="" type="text">
    ...
    <p class="guidelines" id="guide_9"><small>Date of the event for example 15/04/2013</small></p>
</li>
<li id="li_1" >
    ...
    </div><p class="guidelines" id="guide_1"><small>Please provide the title of the event. e.g. Grand Party</small></p>
</li>
<li id="li_8" >
    ...
    </div><p class="guidelines" id="guide_8"><small>Description of the event. Including the time, special guests, DJ, offers etc</small></p>
</li>
<li id="li_7" >
    ...
    </div> <p class="guidelines" id="guide_7"><small>If you have a poster of the event please upload it here. The ideal size of the poster would be 200 x 300 pixel</small></p>
</li>
<li id="li_10" >
    <label class="description" for="element_10">Genre* </label>
    <div>
    <select class="element select medium" id="element_10" name="genre">
    ...
    </div><p class="guidelines" id="guide_10"><small>It is the genre of the event. Please select one from the drop down list.</small></p>
</li>
...
<!-- if it is a client it is disabled -->
    <li id="venueSelector" >
        ...
        </div><p class="guidelines" id="guide_10"><small> Venue associated with this event</small></p>
    </li>
