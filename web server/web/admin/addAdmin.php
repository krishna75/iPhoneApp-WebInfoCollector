...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Register an Admin</a></h1>
		<form id="form_626766" class="appnitro"  method="post" action="">
					<div class="form_description">
			<h2>Register an Admin</h2>
			<p>Please fill in the form below to register and submit. Fields  marked with * can not be left blank</p>
		</div>						
			<ul >
		...
		<span>
			<input id="phone" name="phone1" class="element text" size="3" maxlength="3" value="" type="text"> -
			<label for="phone1">(###)</label>
		</span>
		<span>
			<input id="phone2" name="element_3_2" class="element text" size="3" maxlength="3" value="" type="text"> -
