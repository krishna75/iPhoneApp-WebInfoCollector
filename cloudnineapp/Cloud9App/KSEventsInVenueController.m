...
@interface KSEventsInVenueController ()

@end

@implementation KSEventsInVenueController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    KSEventsInVenue *eventsInVenue = [_eventInVenueArray objectAtIndex:indexPath.row];
