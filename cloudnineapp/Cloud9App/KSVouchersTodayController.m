...
#import "KSVouchersTodayController.h"
#import "KSJson.h"
...
@interface KSVouchersTodayController ()

@end

@implementation KSVouchersTodayController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    KSVouchersToday *vouchersToday = [coreDataResults objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    KSVoucherDetailController *nextViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"voucher"];
