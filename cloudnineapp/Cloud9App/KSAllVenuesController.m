...
#import "KSAllVenuesController.h"
#import "KSJson.h"
#import "KSEventsInVenueController.h"
...
@interface KSAllVenuesController ()

@end

@implementation KSAllVenuesController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // populate
    KSAllVenues *allVenues= [coreDataResults objectAtIndex:indexPath.row];
    ...
    for (KSEventsInVenue *eventsInVenue in allVenues.eventsInVenue) {
...
{
    KSAllVenues * allVenues = [coreDataResults objectAtIndex:indexPath.row];
    KSEventsInVenueController *nextController = [self.storyboard instantiateViewControllerWithIdentifier:@"eventsInAVenue"];
