...
@interface KSEventsInGenreController ()

@end

@implementation KSEventsInGenreController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    KSEventsInGenre *eventsInGenre = [_eventsInGenreArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"KSEventsInGenreController/didSelect...: eventName=%@", eventsInGenre.eventDetails.eventName);
