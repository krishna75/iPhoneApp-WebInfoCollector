...
@implementation KSFirstJsonLoader {
...
+ (void) procesJson{
    ...
    NSLog(@"KSFirstJsonLoader processCoreData: venues: url %@",kjsonVenueURL);
}
...
+ (NSMutableArray *) getVenues{
    [KSFirstJsonLoader processVenues];
