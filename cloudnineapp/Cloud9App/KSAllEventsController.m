...
#import "KSAllEventsController.h"
...
@interface KSAllEventsController ()

@end

@implementation KSAllEventsController {
...
- (void)viewDidLoad {
    ...
    [self decorateView];
    [self addRefreshing];
    NSLog(@"KSAllEventsController/viewDidLoad: KSAllEvents size = %d",[coreDataResults count])  ;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // populate
    KSAllEvents *allEvents =  [coreDataResults objectAtIndex: indexPath.row ];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    KSDailyEventsController *nextController = [self.storyboard instantiateViewControllerWithIdentifier:@"dailyEvents"];
